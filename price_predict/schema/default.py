class ModelConstant:
    ...
    @staticmethod
    def process_data(categories:str, qty:float, product_weight:float, comp_1:float, ps1:float):
        data = ModelConstant.__modelConstants[categories]
        input_data = [qty, product_weight, comp_1, ps1]
        flag = 0
        provide = {}
        
        for i in range(len(ModelConstant.__scaler_data_index)):
            try:
                provide[ModelConstant.__scaler_data_index[i]] = data[ModelConstant.__scaler_data_index[i]]
            except KeyError as e:
                provide[ModelConstant.__scaler_data_index[i]] = input_data[flag]
                flag += 1
        return provide
